...
```bash
  ...
  ./vendor/bin/time-tracking timer:upgrade                   Download latest version of Time Tracking
```
## Contributiong
### Build
### Box install
[Box2](https://github.com/box-project/box) used for .phar generation from php project. PHP 8.1 is required.
```bash
